...
for epoch in range(args.epochs):
    ...
    if acc_eval > max_acc:
        ...
        torch.save(net.state_dict(), './st_01/models/st_01_multi_scale_top_val_acc_'+ args.model + '_' + date_str + '.pth')
        max_acc = acc_eval

    if recall_eval > max_recall:
        print('save model ' + args.model + ' with val recall: {}'.format(recall_eval))
        torch.save(net.state_dict(), './st_01/models/st_01_multi_scale_top_val_rec_'+ args.model + '_' + date_str + '.pth')
