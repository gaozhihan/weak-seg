...
# only fine tune the las conv layer
for param in net.parameters():
    param.requires_grad = False

net.fc_conv.weight.requires_grad = True
net.fc_conv.bias.requires_grad = True

for param in net.layer4.parameters():
    param.requires_grad = True

params_update = list(net.layer4.parameters()) + list(net.fc_conv.parameters())
optimizer = optim.Adam(params_update, lr=args.lr)
# optimizer = optim.Adam(net.parameters(), lr=args.lr)  # L2 penalty: norm weight_decay=0.0001
# optimizer = optim.Adam(net.fc_conv.parameters(), lr=args.lr)
