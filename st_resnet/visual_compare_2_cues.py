...
class VOCDataset(Dataset):
    ...
    def __get_cues_from_img_name(self, img_name):
        ...
        return  cues_numpy1.astype('float32'), cues_numpy2.astype('float32')
    ...
    def __getitem__(self, idx):
        ...
        if self.file_list[idx]+".png" in self.img_id_dic_SEC.keys():
            cues_numpy1, cues_numpy2 = self.__get_cues_from_img_name(self.file_list[idx]+".png")
            cues1 = torch.from_numpy(cues_numpy1)
            cues2 = torch.from_numpy(cues_numpy2)
            return img_ts, label_ts, mask, img_array, cues1, cues2 #self.file_list[idx]  # img_name,
