...
import test_no_gt.voc_data_input_only
...
if args.CRF_model == 'adaptive_CRF':
    ...
    st_crf_layer = test_no_gt.voc_data_input_only.STCRFLayer(False)
...
dataloader = test_no_gt.voc_data_input_only.VOCData(args)
