...
# for original size images, their sizes could be different
def shape_check_collate(batch):
    out = None
    shapes = set([i.shape for i in batch])
...
def my_collate(batch):
    ...
    return [shape_check_collate(samples) for samples in transposed]
