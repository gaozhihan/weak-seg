...
class SaveTest(object):
    def __init__(self,  save_dir=None, data_dir=None, file_list='test.txt'):
        ...
        if save_dir is None:
            save_dir = '/home/data/gaozhihan/project/weak-seg/weak-seg-aux/results/VOC2012/Segmentation/comp5_test_cls'
    ...
    def _get_save_path(self):
        ret = os.path.join(self.save_dir, self.file_list[self.counter] + '.png')
        return ret
    ...
    def save_test(self, mask):
        ...
        save_shape = self._get_save_shape()
